...
import { Box, Button, Container, Grid, Link, Stack, SvgIcon, TextField, Typography } from "@mui/material";
...
const Page = () => {
  ...
  return (
    <>
      <Head>
        <title>Manage Document | Edit Document | SnapHub</title>
      </Head>
      ...
      >
        <Container maxWidth="xxl">
          <div style={{marginBottom:"22px"}}>
            Home	&gt; Sig in	&gt; Dashboard &gt; Manage Document &gt; Edit Document
          </div>
          ...
          <Stack spacing={3}>
            ...
            <Container className="px-0" sx={{margin:"28px auto auto auto !important"}}>
                <Grid container rowSpacing={2} spacing={2} className="card-body impactstoryheader scrollcard-section form">
                        <Grid item xs={12} sm={12} md={12} lg={12}>
                            <Typography variant="h6" sx={{ fontSize: "19px",my:"auto",fontWeight:"500 !important",width:"max-content !important" }}>
                                    Automtaed Folder Pick Up
                            </Typography>
                        </Grid>
                        <Grid item xs={12} sm={12} md={6} lg={6} sx={{display:"grid"}}>
                        ...
                        <Grid item xs={12} sm={12} md={12} lg={12} sx={{display:"grid"}}>
                            <label style={{textAlign:"start"}}>
                            Upload document
                            </label>
                            <TextField id="outlined-basic" label="" variant="outlined" />
                        ...
                        <Grid item xs={12} sm={12} md={12} lg={12} sx={{display:"grid"}}>
                            ...
                            <div style={{display:"flex"}}>
                                ...
                                <div className="image-div">
                                    <img className="profileimg" src="../assets/images/invoice.png"></img>
                                </div>
